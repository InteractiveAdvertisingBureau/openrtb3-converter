...
public class AuditToBidConverter implements Converter<Audit, Bid> {
  ...
  public Bid map(Audit source, Config config, Provider converterProvider)
  ...
  public void enhance(Audit source, Bid target, Config config, Provider converterProvider)
      throws OpenRtbConverterException {
