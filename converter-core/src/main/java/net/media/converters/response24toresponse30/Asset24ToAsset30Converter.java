...
import net.media.openrtb24.response.nativeresponse.NativeData;
import net.media.openrtb24.response.nativeresponse.NativeImage;
import net.media.openrtb24.response.nativeresponse.NativeTitle;
import net.media.openrtb24.response.nativeresponse.NativeVideo;
