...
public class Convert30To25RequestManager {
  ...
  public Convert30To25RequestManager(Provider converterProvider) {
    ...
    converterProvider.register(new Conversion<>(Metric.class, net.media.openrtb25.request.Metric
      .class), new net.media.converters.request30toRequest25.MetricToMetricConverter());
    ...
    converterProvider.register(new Conversion<>(User.class, net.media.openrtb25.request.User.class),
      new
      UserToUserConverter());
    ...
    converterProvider.register(new Conversion<>(OpenRTB.class, BidRequest.class), new
