...
public class BidResponse {
  ...
  public boolean equals(Object o) {
    ...
    if (this$seatbid == null ? other$seatbid != null : !this$seatbid.equals(other$seatbid)) return false;
    ...
    if (this$customdata == null ? other$customdata != null : !this$customdata.equals(other$customdata)) return false;
  ...
  public String toString() {
    return "net.media.openrtb24.response.BidResponse(id=" + this.getId() + ", seatbid=" + this.getSeatbid() + ", bidid=" + this.getBidid() + ", cur=" + this.getCur() + ", customdata=" + this.getCustomdata() + ", nbr=" + this.getNbr() + ", ext=" + this.getExt() + ")";
  }
}
